...
# TODO: fix docs to include step
# create openstackdataplaneservice update

oc apply -f https://raw.githubusercontent.com/openstack-k8s-operators/openstack-operator/main/config/services/dataplane_v1beta1_openstackdataplaneservice_update.yaml
